...
PRIMARY_COLOR = "#0d6efd"  # Blue professional theme
...
if 'grn_entries' not in st.session_state:
...
with tab2:
    ...
    **Address:** {vendor_address}
    ...
    if thread_check:
        st.write("Thread: GO/NO-GO Required")
...
def add_page_number(canvas, doc):
    ...
    canvas.drawRightString(A4[0] - 20*mm, 10*mm, text)
...
with tab3:
    ...
    if st.button("Generate PDF"):
        ...
        # Company Header repeated on every page
